...
function StudyBEmotionRatingScreen({ onNext }) {
    ...
    return (
        ...
        >
            ...
            <h3>3. 감정 표현의 풍부성</h3>
            <p style={{ fontSize: '16px', color: '#555', backgroundColor: '#f0f8ff', padding: '10px', borderRadius: '5px', marginTop: '20px' }}>
            감정 표현의 명확성은 얼마나 감정을 더 잘 풍부하게 표현하는지를 의미합니다. <br/>
            감정이 더 잘 표현될 경우 점수가 <b>높고</b>⬆️, 잘 표현되지 않을수록 점수가 <b>낮습니다⬇️.</b> <br/>
            gif와 함께 보낸 텍스트 메세지를 보고, <b>메시지가 화자의 감정을 잘 표현하는지</b>에 대해서 평가해주시면 됩니다
            </p>
