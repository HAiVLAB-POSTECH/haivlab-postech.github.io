    ...
    return (
        ...
        >
            ...
            <p style={{ fontSize: '16px', color: '#555', backgroundColor: '#f0f0f0', padding: '20px', borderRadius: '5px' }}>
                ...
                <h2 style={{ textAlign: 'left', color: '#333', borderBottom: '2px solid #ddd', paddingBottom: '10px' }}>
                    🗽 단 하루로 완성하는 <span style={{ backgroundColor: '#ffe066', fontWeight: 'bold' }}>{place}</span> 여행 설계
                </h2>
                <p style={{ fontSize: '16px', color: '#555', backgroundColor: '#f0f8ff', padding: '20px', borderRadius: '5px', marginTop: '20px' }}>
                    ...
                    <br/><br/>
                    이번 대화에서는 <b>'<span style={{ backgroundColor: '#ffe066', fontWeight: 'bold' }}>{place}</span> 여행 가이드' 자료</b>를 기반으로, 여행지에서 할 수 있는 <b>관광지/액티비티/식사를 추천하고,</b><br/>
                ...
                {[
                    ...
                    {
                        key: `pre_a3_${place}`,
                        label: "3. [액티비티 계획]  상대방과 함께 할 액티비티는 무엇인가요?",
                    },
                    {
                        key: `pre_a4_${place}`,
                        label: "4. [액티비티 계획] 해당 액티비티를 선택한 이유는 무엇인가요? (*자신의 관심사, 경험, 친구와의 상의 등을 바탕으로 작성)",
                    },
                    {
                        key: `pre_a5_${place}`,
                    ...
                    <div key={key} style={{ marginTop: "20px", color: "#555" }}>
